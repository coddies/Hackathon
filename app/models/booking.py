...
class Booking(Base):
    ...
    cancellation_policy: Mapped[CancellationPolicy] = mapped_column(Enum(CancellationPolicy, name='cancellation_policy'), nullable=False)
    ...
    flight_cancellation_outcome: Mapped[FlightCancellationOutcome | None] = mapped_column(Enum(FlightCancellationOutcome, name='flight_cancellation_outcome'), nullable=True)
...
class Passenger(Base):
    ...
    status: Mapped[PassengerStatus] = mapped_column(Enum(PassengerStatus, name='passenger_status'), default=PassengerStatus.CONFIRMED)
    cancelled_at: Mapped[DateTime | None] = mapped_column(DateTime(timezone=True), nullable=True)
