...
class Refund(Base):
    ...
    refund_type: Mapped[RefundType] = mapped_column(Enum(RefundType, name='refund_type'), nullable=False)
    amount: Mapped[Numeric] = mapped_column(Numeric(12, 2), nullable=False, default=0)
    currency: Mapped[str] = mapped_column(String(3), default="USD")
    status: Mapped[RefundStatus] = mapped_column(Enum(RefundStatus, name='refund_status'), default=RefundStatus.PENDING)
