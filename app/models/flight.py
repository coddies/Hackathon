...
from sqlalchemy import String, Integer, DateTime, Enum, Numeric, ForeignKey, func, UniqueConstraint
...
class SeatInventory(Base):
    ...
    overbooking_policy: Mapped[OverbookingPolicy] = mapped_column(Enum(OverbookingPolicy), default=OverbookingPolicy.HARD_NEVER_OVERSELL)
    ...
    group_booking_policy: Mapped[GroupBookingPolicy] = mapped_column(Enum(GroupBookingPolicy), default=GroupBookingPolicy.FULL_FAIL)
